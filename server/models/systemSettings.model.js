    ...
    const query = `
            ...
            BEGIN
                CREATE TABLE dbo.system_settings (
                    ...
                    siteName NVARCHAR(100) DEFAULT 'Learning Management System',
                    siteDescription NVARCHAR(500) DEFAULT 'Advanced Learning Management System',
                    siteUrl NVARCHAR(200) DEFAULT 'https://lms.example.com',
                    adminEmail NVARCHAR(255) DEFAULT 'admin@example.com',
                    timezone NVARCHAR(50) DEFAULT 'UTC',
                    language NVARCHAR(10) DEFAULT 'en',
                    dateFormat NVARCHAR(20) DEFAULT 'YYYY-MM-DD',
                    timeFormat NVARCHAR(20) DEFAULT '24h',
                    ...
                    smtpHost NVARCHAR(100) DEFAULT '',
                    smtpPort INT DEFAULT 587,
                    smtpUsername NVARCHAR(100) DEFAULT '',
                    smtpPassword NVARCHAR(200) DEFAULT '',
                    smtpEncryption NVARCHAR(10) DEFAULT 'tls',
                    fromEmail NVARCHAR(255) DEFAULT '',
                    fromName NVARCHAR(100) DEFAULT '',
                    
                    maintenanceMode BIT DEFAULT 0,
                    maintenanceMessage NVARCHAR(500) DEFAULT 'System is under maintenance. Please check back later.',
                    maxFileUploadSize INT DEFAULT 10,
                    allowedFileTypes NVARCHAR(200) DEFAULT 'jpg,jpeg,png,pdf,doc,docx,txt',
