...
const InstructorDetailHeader = ({ instructor, onEdit }) => {
  ...
  return (
    <Card className="overflow-hidden border-0 shadow-lg">
      ...
      <div className="relative h-40 bg-gradient-to-r from-[#2563eb] via-[#9333ea] to-[#4338ca] overflow-hidden">
      ...
      <CardContent className="relative pt-0 px-6">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-4 md:gap-6">
            ...
            <div className="relative">
              <Avatar className="h-28 w-28 border-4 border-background shadow-lg">
                ...
                <AvatarFallback className="text-2xl bg-gradient-to-r from-[#dbeafe] to-[#f3e8ff] text-[#1e40af]">
              ...
              {instructor.status === "ACTIVE" && (
                <div className="absolute bottom-2 right-2 w-5 h-5 bg-[#22c55e] rounded-full border-2 border-background"></div>
              )}
            </div>
            ...
            <div className="text-center md:text-left mb-4 md:mb-6">
              ...
              {instructor.title && (
                <p className="text-[#2563eb] font-medium mt-1 flex items-center justify-center md:justify-start gap-1">
        ...
        {/* Bio section */}
        {instructor.bio && (
          <div className="mt-6 p-5 bg-gradient-to-r from-[#eff6ff] to-[#faf5ff] rounded-xl border">
