      ...
      <div className="space-y-4 sm:space-y-6">
        <Card className="w-full border-dashed">
          <CardContent className="p-6 sm:p-8 text-center">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 text-gray-900">No Batch Assigned</h3>
            <p className="text-muted-foreground mb-6 text-sm sm:text-base max-w-md mx-auto leading-relaxed">
              You are not currently assigned to any batch. Please contact your administrator for course enrollment assistance.
            </p>
