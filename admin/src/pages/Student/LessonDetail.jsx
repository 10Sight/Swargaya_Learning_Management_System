...
const LessonDetail = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6]">
        <div className="sticky top-0 bg-white border-b z-10 shadow-sm">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div className="flex items-center gap-4">
              ...
              <div className="h-6 w-48 bg-[#e5e7eb] rounded animate-pulse" />
            </div>
          </div>
        </div>
        <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
          <div className="space-y-4">
            ...
            <div className="h-64 sm:h-80 bg-[#e5e7eb] rounded-lg animate-pulse" />
            <div className="h-32 bg-[#e5e7eb] rounded-lg animate-pulse" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] flex items-center justify-center p-4">
        <div className="max-w-md mx-auto text-center">
          <div className="p-6 sm:p-8 bg-white rounded-lg shadow-lg border">
            <div className="mb-6">
              <BookOpen className="h-12 w-12 sm:h-16 sm:w-16 text-[#ef4444] mx-auto mb-4" />
              <h3 className="text-lg sm:text-xl font-bold text-[#111827] mb-2">Lesson Not Found</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6]">
      ...
      <div className="sticky top-0 bg-white/95 backdrop-blur-sm border-b border-[#e5e7eb] z-20 shadow-sm">
          ...
          <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
              <Button
                ...
                className="shrink-0 text-xs sm:text-sm hover:bg-[#eff6ff] hover:border-[#93c5fd] transition-colors duration-200"
              >
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base sm:text-lg lg:text-xl font-bold text-[#111827] leading-tight truncate">
                  {lesson.title || "Lesson"}
                </h1>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {isCompleted ? (
                <div className="flex items-center gap-2">
                  <Badge className="bg-[#dcfce7] text-[#166534] border-[#86efac] px-3 py-1.5 text-xs sm:text-sm font-medium">
                    <CheckCircle2 className="h-3 w-3 mr-1.5" />
                    Completed
                  </Badge>
                  <div className="hidden sm:flex items-center text-xs text-[#16a34a]">
      ...
      >
        ...
        <Card className="shadow-lg border-0 bg-white">
          <CardHeader className="bg-gradient-to-r from-[#eff6ff] to-[#eef2ff] border-b">
          ...
          <CardContent className="p-4 sm:p-6 lg:p-8">
            {slides.length > 0 ? (
              <div className="max-w-none">
                ...
                <div className="flex items-center justify-center gap-2 mt-4">
                  {slides.map((_, i) => (
                    <button key={i} aria-label={`Go to slide ${i + 1}`} onClick={() => setSlideIndex(i)} className={`h-2.5 w-2.5 rounded-full ${i === slideIndex ? 'bg-[#2563eb]' : 'bg-[#d1d5db]'} hover:bg-[#3b82f6]`} />
                  ))}
                </div>
              </div>
            ) : (
              <div className="prose prose-sm sm:prose-base max-w-none">
                {lesson.content ? (
                  <div className="whitespace-pre-wrap text-[#374151] leading-relaxed text-sm sm:text-base">
                    {lesson.content}
                  </div>
                ) : (
            ...
            {slides.length === 0 && (
              <div className="mt-8 sm:mt-12 space-y-6 sm:space-y-8">
                <div className="bg-gradient-to-r from-[#eff6ff] to-[#eef2ff] rounded-lg p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-bold text-[#1e3a8a] mb-4 flex items-center gap-2">
                    <Target className="h-4 w-4 sm:h-5 sm:w-5" />
                    Learning Objectives
                  </h3>
                  <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-[#3b82f6] text-white rounded-full flex items-center justify-center text-xs font-bold mt-0.5">1</div>
                      <span>Understand the core concepts covered in this lesson</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-[#3b82f6] text-white rounded-full flex items-center justify-center text-xs font-bold mt-0.5">2</div>
                      <span>Apply the knowledge to practical scenarios</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-[#3b82f6] text-white rounded-full flex items-center justify-center text-xs font-bold mt-0.5">3</div>
                      <span>Build upon previous lessons for comprehensive learning</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-gradient-to-r from-[#fffbeb] to-[#fff7ed] border-l-4 border-[#fb923c] rounded-r-lg p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-bold text-[#7c2d12] mb-3 flex items-center gap-2">
                    <AlertCircle className="h-4 w-4 sm:h-5 sm:w-5" />
                    Key Points
                  </h3>
                  <p className="text-[#9a3412] text-sm sm:text-base leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-6">
                  <div className="p-4 bg-[#f0fdf4] rounded-lg border border-[#bbf7d0]">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-[#166534] text-sm">Remember</span>
                    </div>
                  ...
                  <div className="p-4 bg-[#faf5ff] rounded-lg border border-[#e9d5ff]">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-[#6b21a8] text-sm">Pro Tip</span>
                    </div>
                    <p className="text-[#7e22ce] text-sm leading-relaxed">
        ...
        {resources.length > 0 && (
          <Card className="border-[#86efac] bg-gradient-to-br from-[#f0fdf4] to-[#ecfdf5] shadow-lg">
            <CardHeader className="bg-gradient-to-r from-[#dcfce7] to-[#d1fae5] border-b border-[#bbf7d0]">
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="p-2 bg-[#22c55e] rounded-lg">
                    <Download className="h-4 w-4 sm:h-5 sm:w-5 text-[#ffffff]" />
                  </div>
                  <span className="text-base sm:text-lg">Lesson Resources</span>
                  <Badge className="bg-[#22c55e] text-[#ffffff] border-0 px-3 py-1 text-xs sm:text-sm">
                    {resources.length} resource{resources.length > 1 ? 's' : ''}
                  </Badge>
                </div>
              </CardTitle>
              <p className="text-xs sm:text-sm text-[#15803d] mt-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                {resources.map((resource, index) => {
                  ...
                  return (
                    <div
                      key={resourceId}
                      className="group flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-lg border-2 border-white bg-white/80 backdrop-blur-sm hover:shadow-md hover:border-[#bbf7d0] transition-all duration-300"
                    >
                      <div className="flex items-start gap-3 flex-1 min-w-0">
                        <div className="p-2 sm:p-3 bg-[#dcfce7] rounded-lg group-hover:bg-[#bbf7d0] transition-colors duration-300">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                            ...
                            <Badge
                              variant="outline"
                              className={`text-xs self-start sm:self-auto ${resource.type === 'video' ? 'border-[#fecaca] text-[#b91c1c] bg-[#fef2f2]' :
                                resource.type === 'pdf' ? 'border-[#bfdbfe] text-[#1d4ed8] bg-[#eff6ff]' :
                                  resource.type === 'link' ? 'border-[#e9d5ff] text-[#7e22ce] bg-[#faf5ff]' :
                                    'border-[#e5e7eb] text-[#374151] bg-[#f9fafb]'
                                }`}
                            >
                      ...
                      <div className="flex flex-row sm:flex-col lg:flex-row items-center gap-2 shrink-0">
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="flex-1 sm:flex-none h-8 sm:h-9 text-xs sm:text-sm hover:bg-[#f0fdf4] hover:border-[#86efac]"
                        >
                          {resource.type === 'video' ? (
                            <>
                        ...
                        {resource.type !== 'link' && (
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="flex-1 sm:flex-none h-8 sm:h-9 text-xs sm:text-sm hover:bg-[#eff6ff] hover:border-[#93c5fd]"
                          >
        ...
        {!isCompleted && (
          <Card className="border-[#93c5fd] bg-gradient-to-br from-[#eff6ff] to-[#eef2ff] shadow-lg">
            <CardContent className="p-4 sm:p-6 text-center">
              <div className="relative mb-4">
                {hasReachedBottom ? (
                  <CheckCircle2 className="h-12 w-12 sm:h-16 sm:w-16 text-[#22c55e] mx-auto animate-bounce" />
                ) : (
                  <ScrollText className="h-12 w-12 sm:h-16 sm:w-16 text-[#3b82f6] mx-auto" />
                )}
                <div className="absolute inset-0 bg-[#bfdbfe] rounded-full blur-xl opacity-30 animate-pulse"></div>
              </div>

              <h3 className="text-base sm:text-lg font-bold mb-3 text-[#111827]">
                {hasReachedBottom ? (
                  completingLesson ? (
                    ...
                    <span className="text-[#15803d]">🎉 Great! Lesson will be marked complete shortly.</span>
                  )
                ) : (
                  <span className="text-[#1d4ed8]">📖 Continue reading to complete this lesson</span>
                )}
              </h3>

              <p className="text-xs sm:text-sm text-[#4b5563] mb-4 leading-relaxed max-w-sm mx-auto">
                {hasReachedBottom ? (
              ...
              <div className="max-w-xs mx-auto">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-xs font-medium text-[#4b5563]">Progress</span>
                ...
                <Progress
                  value={scrollProgress}
                  className="h-2.5 sm:h-3 bg-[#e5e7eb]"
                />
        ...
        {isCompleted && (
          <Card className="border-[#86efac] bg-gradient-to-br from-[#f0fdf4] via-[#ecfdf5] to-[#f0fdfa] shadow-xl">
            <CardContent className="p-6 sm:p-8 text-center">
              <div className="relative mb-6">
                <Trophy className="h-16 w-16 sm:h-20 sm:w-20 text-[#eab308] mx-auto animate-bounce" />
                <div className="absolute inset-0 bg-[#fde047] rounded-full blur-xl opacity-30 animate-pulse"></div>
              ...
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#166534] mb-3">
                🎉 Lesson Completed!
              </h3>

              <p className="text-sm sm:text-base text-[#15803d] mb-6 max-w-md mx-auto leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-sm mx-auto">
                <Button
                  onClick={handleBackToCourse}
                  className="flex-1 bg-[#16a34a] hover:bg-[#15803d] text-[#ffffff] shadow-lg hover:shadow-xl transition-all duration-300"
                  size="lg"
                >
                ...
                <Button
                  onClick={() => window.location.reload()}
                  variant="outline"
                  className="flex-1 border-[#86efac] text-[#15803d] hover:bg-[#f0fdf4]"
                  size="lg"
                >
                  <RefreshCw className="h-4 w-4 mr-2" />
              ...
              {/* Achievement badge */}
              <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-[#fef9c3] rounded-full border border-[#fde047]">
                <Award className="h-4 w-4 text-[#ca8a04]" />
                <span className="text-xs sm:text-sm font-medium text-[#854d0e]">
