  ...
  return (
    <AccountStatusWrapper allowPending={false}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer border-l-4 border-l-orange-500" onClick={() => navigate('/student/batch')}>
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                <p className="text-xs sm:text-sm font-medium text-muted-foreground truncate">Batch Status</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="space-y-2">
                <p className="text-xs sm:text-sm font-medium text-muted-foreground">Batch Name</p>
                <p className="font-semibold break-words text-sm sm:text-base">{dashboardData.batch.name}</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Badge 
                  variant={dashboardData.batch.status === 'ACTIVE' ? 'default' : 'secondary'}
                  className={`text-xs px-3 py-1 ${
                    dashboardData.batch.status === 'ACTIVE' 
                ...
                {dashboardData.batch.startDate && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-sm sm:text-base">{formatDate(dashboardData.batch.startDate)}</p>
                    </div>
                  </div>
                )}
                ...
                {dashboardData.batch.endDate && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-sm sm:text-base">{formatDate(dashboardData.batch.endDate)}</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            ...
            >
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="text-left flex-1 min-w-0">
                  <p className="font-medium text-sm sm:text-base truncate">View Batch</p>
                  <p className="text-xs text-muted-foreground leading-tight">
                    <span className="hidden sm:inline">Check batch details</span>
                    <span className="sm:hidden">Batch info</span>
                  </p>
                </div>
              </div>
            </Button>
